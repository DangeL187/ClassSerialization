...
class MyClass : public Parent, public Parent2 {
  DEFINE_SERIALIZE(_int_protected, _bool, _char, _double, _float, _long,
                   _long_long, _short, _string, _ptr_int, _ptr_string, _q_int,
                   _q_string, _s_ptr_int, _s_ptr_string, _stack_int,
                   _stack_string, _v_int, _v_string)
